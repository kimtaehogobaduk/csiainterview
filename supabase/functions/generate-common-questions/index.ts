...
const SCHOOL_INFO: Record<string, { name: string; focus: string; detailedInfo: string }> = {
  cheongshim: {
    ...
    detailedInfo: `청심국제고등학교는 경기도 가평에 위치한 자율형 사립고등학교입니다. ACG(Academic, Character, Global) 교육 철학. 3년 전원 기숙사 생활, 글로벌 리더십 프로그램, 봉사활동 필수, 건학 이념에 기반한 인성교육. 인재상: 봉사정신과 글로벌 리더십을 갖춘 인재. 면접 중점: 지원 동기의 진정성, ACG 교육 철학 이해도, 기숙사 생활 적응력, 봉사 경험, 글로벌 시각. 특별한 전통: 효정 문화, 참부모 교육, 자연 속 교육환경 활용.`
  },
  hana: {
    name: '하나고등학교',

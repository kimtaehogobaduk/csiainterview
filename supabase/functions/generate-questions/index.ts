...
const SCHOOL_DETAILED: Record<string, { name: string; focus: string; detailedInfo: string }> = {
  ...
  daeil: { name: '대일외국어고등학교', focus: '외국어, 인성, 국제 이해, 자기주도성', detailedInfo: `대일외국어고등학교는 서울 외국어고. 외국어+인성 겸비. 면접에서 외국어 학습, 인성, 국제 이해, 자기주도학습 중시.` },
  myungduk: { name: '명덕외국어고등학교', focus: '창의성, 외국어, 글로벌 마인드, 학업 열정', detailedInfo: `명덕외국어고등학교는 서울 외국어고. 창의적 사고+글로벌 소양. 면접에서 창의성, 외국어, 글로벌 마인드, 학업 열정 중시.` },
  gyeonggi: { name: '경기외국어고등학교', focus: '외국어 학습 동기, 국제 이슈, 다문화, 학업 계획', detailedInfo: `경기외국어고등학교는 경기도 외국어고. 외국어+국제화. 면접에서 외국어 동기, 국제 이슈, 다문화, 진로 계획 중시.` },
  ...
  incheon: { name: '인천외국어고등학교', focus: '외국어, 국제 감각, 자기주도학습, 진로 계획', detailedInfo: `인천외국어고등학교는 인천 외국어고. 외국어 심화+국제교류. 면접에서 외국어, 국제 감각, 자기주도학습, 진로 계획 중시.` },
  other: { name: '자율형 사립고/외국어고', focus: '자기주도학습, 진로 목표, 학업 열정, 인성', detailedInfo: `자율형 사립고/외국어고. 자기주도적 학습, 창의성, 리더십. 면접에서 자기주도학습, 진로 목표, 학업 열정, 인성 중시.` }
};

...
1. 자소서 내용과의 일치성 (0-20점)
   - 자소서 내용을 일부만 인용하거나 관련 경험을 언급해도 인정합니다.
   - 완전히 모순되거나 관련 없음: 0-8점
   - 자소서의 일부 내용이나 관련 경험 언급: 9-14점
   - 자소서 내용과 잘 연결됨: 15-17점
   - 자소서를 깊이 있게 확장하여 답변: 18-20점

2. 구체성과 진정성 (0-20점)
   - 매우 추상적이고 성의 없는 답변: 0-8점
   - 일반적인 수준의 답변: 9-14점
   - 구체적인 예시가 있는 답변: 15-17점
   - 매우 구체적이고 진심이 느껴지는 답변: 18-20점

3. 논리성과 설득력 (0-20점)
   - 논리가 없거나 심하게 모순됨: 0-8점
   - 논리가 약하지만 이해는 가능: 9-14점
   - 논리적이고 설득력 있음: 15-17점
...
점수 기준 (학생의 노력을 인정하는 방향으로):
- 90-100점: 매우 뛰어난 답변. 모든 항목에서 우수함.
- 80-89점: 우수한 답변. 대부분의 항목에서 좋은 평가.
- 70-79점: 양호한 답변. 전반적으로 준비가 되어 있음.
- 60-69점: 보통 수준의 답변. 개선이 필요한 부분이 있음.
- 50-59점: 부족한 부분이 있지만 노력은 보임.
- 40-49점: 준비가 부족하지만 가능성은 있음.
- 0-39점: 상당한 준비가 필요함.

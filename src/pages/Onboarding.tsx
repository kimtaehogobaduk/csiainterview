...
const AI_MODELS = [
  { value: 'google/gemini-3.8-flash', label: 'Gemini 3.8 Flash (권장)', description: '빠르고 정확한 응답' },
  { value: 'google/gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro', description: '더 깊은 분석과 피드백' },
  { value: 'openai/gpt-5.4-mini', label: 'GPT-5.4 Mini', description: '균형 잡힌 성능' },
];
